...
const uint32_t defaultFrequency = 900000000;
/*********************************************************************************************************************************
...
int main() {
    ...
    while(1) {
        ...
        if (!BLE_IS_CONNECTED) {// !BLE_IS_CONNECTED
        ...
        else if (send_freq_registers_flag == true) {
            sendPLLFreqRegisters();
            send_freq_registers_flag = false;
        }
        else if (restore_default_registers_flag == true) {
            restoreAllValues();
